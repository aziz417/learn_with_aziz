  ...
  return (
    ...
    >
      ...
      >
        ...
        digital experiences. My current area of focus is in the <span className="text-AAsecondary">{"React -> NextJs "}</span>
        And
        <span className="text-AAsecondary">{" PHP -> Laravel"}</span>,
        where I actively engage in developing <br className="2xl:block hidden" />
        and designing immersive <span className="text-AAsecondary">web applications</span>.
        {/*       
      ...
      <motion.div
        ...
        className="mt-12"
      >
        <a href={"https://drive.google.com/file/d/1lcRDBhEVHXY4WAzIiFBTKa7gHfa-mEPQ/view"} target={"_blank"} rel="noreferrer">
